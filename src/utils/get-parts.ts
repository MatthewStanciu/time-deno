import { LightningTimeRawParts, LightningTimeParts } from '../types/index.ts'

const getParts = (lightningString: string): LightningTimeRawParts => {
...
const toString = (parts: LightningTimeRawParts): LightningTimeParts => {
